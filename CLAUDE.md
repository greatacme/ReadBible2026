...
- `bible_ver_cd = 'KLB'` → YouVersion Platform API [현대인의 성경]
...
- 내부 테이블 버전 (RNKSV 등): Supabase `verse`, `section_heading`, `footnote` 테이블에 해당 버전 데이터 필요
